...
class SyncPhaseCalibrationOptimizationTests(unittest.TestCase):
    def test_archive_exposes_joint_ac_optimization_preview(self):
        ...
        self.assertIn("Named analysis copies", archive_html)
        self.assertIn("Save analysis copy", archive_html)
        self.assertIn("saveSyncAnalysisCopy", archive_html)
        self.assertIn("loadSelectedSyncAnalysisCopy", archive_html)
        self.assertIn("syncAnalysisCopies", archive_html)
