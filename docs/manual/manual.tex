...
settling delay, and use their own configured $\Delta\nu_{780}$, atom--mirror distance and
phase-noise value when normalizing and archiving their response. For each Slave, the
signed normalized quadratures are subtracted before squaring,
\begin{equation}
 \Delta S_0=S_{0,\mathrm{Master}}-S_{0,\mathrm{Slave}},\qquad
 \Delta S_{90}=S_{90,\mathrm{Master}}-S_{90,\mathrm{Slave}},
\end{equation}
