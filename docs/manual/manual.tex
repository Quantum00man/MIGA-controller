...
controller then rebuilds the linear $I_\alpha(t)$ history and recalculates the displayed
...
press \ui{Preview}.  The resulting curve always uses linear interpolation in physical time
and nearest-endpoint extrapolation.  \ui{Save copy} records the selection under a user name;
