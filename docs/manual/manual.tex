...
Before enabling automatic recovery, select a dedicated Bragg Fringes Calibration MOT and
verify the calibration parameters. On confirmation, the controller creates a separate,
