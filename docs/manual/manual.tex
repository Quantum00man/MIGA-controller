...
sequence mean reaches a requested target. The available parameters are the atom-number
...
selected, with Fit \ui{Interferometer P UP} and target zero as defaults. The calculation
