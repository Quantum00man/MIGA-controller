...
An initial block is always acquired.  Periodic blocks are inserted at safe phase-block
boundaries after the requested elapsed time, and a normally completed run acquires a final
