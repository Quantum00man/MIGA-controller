...
All measured Allan curves include asymmetric one-standard-deviation confidence bars. Under
...
\begin{equation}
  ...
  {\chi^2_{(1-p)/2,\nu_{\mathrm{eff}}}}}.
\end{equation}
The CSV exports record both limits, the lower and upper error magnitudes, the white-noise
