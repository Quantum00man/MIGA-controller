...
\end{equation}
This is not the difference of the already squared single-node responses. If only one
quadrature is selected, the UI reports that component and its square without claiming a
complete two-quadrature magnitude. The sync manifest retains the signed components,
