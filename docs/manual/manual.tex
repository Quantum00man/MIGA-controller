...
press \ui{Preview}.  The interpolation selector offers linear interpolation, nearest-point
...
extrapolating.  \ui{Save copy} records both the point selection and interpolation method;
